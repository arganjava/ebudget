...
<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Material Create Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo site_url('material/save');?>" method="post" >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="buying_price" class="form-control" id="inputPassword3" placeholder="Buying Price" type="number">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="unit" class="form-control" id="inputPassword3" placeholder="Unit" type="text">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="type" class="form-control" id="inputPassword3" placeholder="Type" type="text">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
